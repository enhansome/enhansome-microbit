...
[![awesome micro:bit logo](https://user-images.githubusercontent.com/4189262/60908738-830bb780-a274-11e9-9d86-6b82ab89334f.png)](https://github.com/carlosperate/awesome-microbit) ⭐ 1,200 | 🐛 6 | 🌐 HTML | 📅 2026-05-21
...
Inspired by the [Awesome lists](https://github.com/sindresorhus/awesome) ⭐ 507,491 | 🐛 106 | 📅 2026-09-02.
...
* [OpenBlock](https://github.com/openblockcc/openblock-desktop) ⭐ 301 | 🐛 10 | 🌐 JavaScript | 📅 2025-06-12 - Block programming with hardware device support, including micro:bit, with code generation, compilation, flashing, and serial connection.
...
* [pyscrlink](https://github.com/kawasaki/pyscrlink) ⭐ 127 | 🐛 16 | 🌐 Python | 📅 2023-09-18 - A Scratch-link for Linux to connect Scratch 3.0 to Bluetooth devices such as the micro:bit.
...
* [PCA9685](https://github.com/gingemonster/PCA9685-Python-Microbit) ⭐ 26 | 🐛 3 | 🌐 Python | 📅 2017-01-28 - Class for using the PCA9685 16-Channel 12-bit PWM/Servo Driver via I2C.
...
* [micro:bit MicroPython stubs](https://github.com/microbit-foundation/micropython-microbit-stubs) ⭐ 6 | 🐛 13 | 🌐 Python | 📅 2026-09-17 - Type stubs for MicroPython for micro:bit to support the editor autocompletion.
...
* [DSTemp](https://github.com/bsiever/microbit-dstemp) ⭐ 5 | 🐛 5 | 🌐 C++ | 📅 2026-06-27 - Read the temperature from one or multiple DS18B20 sensors.
...
* [microbit-web-bluetooth](https://github.com/thegecko/microbit-web-bluetooth) ⭐ 56 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-16 - Web Bluetooth library implementing the micro:bit Bluetooth Profile.
...
* [microbitFs](https://github.com/microbit-foundation/microbit-fs) ⭐ 15 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-17 - TypeScript library to manipulate files inside a micro:bit MicroPython hex file.
* [microbitUh](https://github.com/microbit-foundation/microbit-universal-hex/) ⭐ 13 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-17 - TypeScript/JavaScript library to combine micro:bit Hex files into a Universal Hex that works in all versions of the micro:bit.
...
* [Arduino nRF5](https://github.com/sandeepmistry/arduino-nRF5/) ⭐ 954 | 🐛 130 | 🌐 C | 📅 2024-05-22 - Arduino Core for Nordic Semiconductor nRF5 based boards, including the micro:bit.
...
* [Mynewt](https://github.com/apache/mynewt-core) ⭐ 891 | 🐛 98 | 🌐 C | 📅 2026-09-18 - Open-source operating system for tiny embedded devices. Its goal is to make it easy to develop applications for microcontroller environments where power and cost are driving factors.
...
* [The Discovery book](https://github.com/rust-embedded/discovery/) ⭐ 1,608 | 🐛 108 | 🌐 Rust | 📅 2026-03-21 - This book is an introductory course on microcontroller-based embedded systems, using micro:bit, that uses Rust as the teaching language rather than the usual C/C++.
...
* [Tock](https://github.com/tock/tock/blob/master/boards/microbit_v2/README.md) ⭐ 6,444 | 🐛 217 | 🌐 Rust | 📅 2026-09-18 - An embedded operating system designed for running multiple concurrent, mutually distrustful applications on low-memory and low-power microcontrollers, with support for the BBC micro:bit.
...
* [Ada Drivers](https://github.com/AdaCore/Ada_Drivers_Library/tree/master/examples/MicroBit) ⭐ 286 | 🐛 23 | 🌐 Ada | 📅 2026-08-19 - Drivers for the micro:bit on-board components and instruction on how to setup the Ada development environment.
...
* [C# / F#](https://github.com/kekyo/IL2C) ⭐ 447 | 🐛 43 | 🌐 C# | 📅 2022-06-19 - IL2C is a translator implementation of .NET intermediate language to C language, with C# and F# examples for the micro:bit.
...
* [Docker micro:bit Toolchain](https://github.com/carlosperate/docker-microbit-toolchain) ⭐ 18 | 🐛 3 | 🌐 Shell | 📅 2022-06-08 - Docker image with the micro:bit toolchain, useful to easily compile C/C++ programmes like DAL & CODAL (the micro:bit runtime), MicroPython, DAPLink, etc.
...
* [OpenHaystack](https://github.com/seemoo-lab/openhaystack) ⭐ 13,559 | 🐛 145 | 🌐 Swift | 📅 2026-08-17 - Framework for tracking personal Bluetooth devices via Apple's massive Find My network. Build your own 'AirTags' with a micro:bit.
* [BtleJack](https://github.com/virtualabs/btlejack) ⭐ 2,111 | 🐛 28 | 🌐 Python | 📅 2024-08-04 - Based on the micro:bit, it provides everything you need to sniff, jam and hijack Bluetooth Low Energy devices.
...
* [DAPLink source code](https://github.com/ARMmbed/DAPLink) ⭐ 2,805 | 🐛 140 | 🌐 C | 📅 2026-08-20 - Source code for DAPLink, the firmware running on the Interface Chip.
...
* [micro:bit PCB Edge Connector](https://github.com/JohnVidler/kicad-microbit-v2-edge-connector) ⭐ 3 | 🐛 1 | 📅 2024-06-26 - A reproduction of the micro:bit V2 PCB edge connector for KiCAD.
...
* [Python For Kids](https://github.com/mytechnotalent/Python-For-Kids) ⭐ 799 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - A comprehensive online Python development course for kids utilizing a BBC micro:bit going step-by-step into the world of Python for microcontrollers.
