...
[![awesome micro:bit logo](https://user-images.githubusercontent.com/4189262/60908738-830bb780-a274-11e9-9d86-6b82ab89334f.png)](https://github.com/carlosperate/awesome-microbit) ⭐ 1,196 | 🐛 6 | 🌐 HTML | 📅 2026-05-21
...
Inspired by the [Awesome lists](https://github.com/sindresorhus/awesome) ⭐ 495,723 | 🐛 100 | 📅 2026-06-30.
...
* [OpenBlock](https://github.com/openblockcc/openblock-desktop) ⭐ 295 | 🐛 10 | 🌐 JavaScript | 📅 2025-06-12 - Block programming with hardware device support, including micro:bit, with code generation, compilation, flashing, and serial connection.
...
* [pyscrlink](https://github.com/kawasaki/pyscrlink) ⭐ 126 | 🐛 16 | 🌐 Python | 📅 2023-09-18 - A Scratch-link for Linux to connect Scratch 3.0 to Bluetooth devices such as the micro:bit.
* [mbit-more](https://github.com/microbit-more/mbit-more-v2/) ⭐ 40 | 🐛 10 | 🌐 JavaScript | 📅 2026-01-25 - A third party Scratch extension with extra features, including visualising sensor data and support for V1 and V2 micro:bit.
* [s2m](https://github.com/MrYsLab/s2m) ⭐ 33 | 🐛 1 | 🌐 Python | 📅 2019-08-28 - A Python program that acts as a bridge between the Scratch 2 off-line editor and the micro:bit via USB.
* [s2microbit BLE](https://github.com/memakura/s2microbit-ble#English) ⭐ 9 | 🐛 0 | 🌐 JavaScript | 📅 2024-05-09 - Scratch 2 (offline) extension for BBC micro:bit bluetooth connection with a Windows PC.
...
* [Micropython-MakeCode compatible Radio](https://github.com/rhubarbdog/microbit-radio) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2020-05-10 - Class MakeRadio which includes all the functionality of the MicroPython radio module, while being compatible with MakeCode blocks.
* [Decimal Numbers](https://github.com/rhubarbdog/decimal-numbers) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2022-11-08 - A Class to perform mathematics using actual decimal numbers (not floating point numbers).

### 🐍 MicroPython Libraries - Hardware drivers

* [SSD1306](https://github.com/fizban99/microbit_ssd1306) ⭐ 61 | 🐛 6 | 🌐 Python | 📅 2024-04-19 - Library to control the OLED SSD1306 128x64 I2C with a micro:bit.
* [micro:bit python libs](https://github.com/shaoziyang/microbit-lib) ⭐ 56 | 🐛 6 | 🌐 Python | 📅 2019-07-08 - Growing collection of modules, including TM1637/TM1650 7-seg LEDs, OLED 128x64, LCD1602, AT24XX EEPROM, DS1302/DS1307/DS3231 RTC, NeoPixel drivers, APDS9930 Digital Proximity and Ambient Light Sensor, BME280 humidity and pressure sensor, BMP280/BMP180 pressure sensors.
* [ULN2003](https://github.com/IDWizard/uln2003) ⭐ 49 | 🐛 1 | 🌐 Python | 📅 2017-07-29 - Module to drive stepper motors via ULN2003 darlington transistors.
* [PCA9685](https://github.com/gingemonster/PCA9685-Python-Microbit) ⭐ 27 | 🐛 3 | 🌐 Python | 📅 2017-01-28 - Class for using the PCA9685 16-Channel 12-bit PWM/Servo Driver via I2C.
* [Servo](https://github.com/microbit-playground/microbit-servo-class) ⭐ 21 | 🐛 4 | 🌐 Python | 📅 2016-12-28 - Class for controlling servos on the micro:bit via PWM.
* [HC-SR04](https://github.com/fizban99/microbit_hcsr04) ⭐ 18 | 🐛 2 | 🌐 Python | 📅 2021-07-24 - Library to read the distance from a HC-SR04 ultrasonic sensor using the SPI peripheral.
* [TM1637](https://github.com/mcauser/microbit-tm1637) ⭐ 14 | 🐛 2 | 🌐 Python | 📅 2019-01-23 - Library for quad 7-segment LED display modules using the TM1637 LED driver.
* [Nokia 5110 PCD8544 LCD](https://github.com/matneee/microbit-nokia5110-PCD8544-lcd) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2025-03-20 - Fast controller for Nokia 5110 LCDs.
* [SSD1306 7seg](https://github.com/fizban99/microbit_ssd1306_7seg) ⭐ 9 | 🐛 1 | 🌐 Python | 📅 2021-07-24 - Library to use an SSD1306 OLED display as a 7 segment display.
* [SSD1306 SPI](https://github.com/fizban99/microbit_ssd1306spi) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2021-07-24 - Library to control the OLED SSD1306 128x64 display with a micro:bit via SPI.
* [US-100](https://github.com/fizban99/microbit_us100) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2021-07-24 - Library to read the distance from a US-100 ultrasonic sensor via UART.
* [MAX7219 7-segment](https://github.com/microbit-playground/matrix7seg) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2017-06-03 - Module for using a 7-segment display driven by a MAX7219 chip via SPI.
* [DHT11](https://github.com/rhubarbdog/microbit-dht11) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2022-10-03 - Library for for the DHT11 temperature and humidity sensor over 1 wire.
* [RAK811](https://github.com/PiSupply/rak811-python) ⚠️ Archived - RAK811 Python library for use with LoRa pHAT & micro:bit Node.
...
* [VEML6030](https://github.com/CoreElectronics/CE-PiicoDev-VEML6030-MicroPython-Module) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2021-10-05 - Library for interfacing with a VEML6030 Ambient Light Sensor via I2C.
* [MAX7219 matrix](https://github.com/titimoby/microbit4all/blob/master/libraries/matrix7219.py) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2020-07-12 - Module for using a 8x8 LED Matrix driven by a MAX7219 chip via SPI.
* [HT16K33](https://github.com/mcauser/deshipu-micropython-ht16k33) ⚠️ Archived - Library for the HT16K33 LED matrix driver in multiple configurations (16x8, 8x8 or 8x8x2).
* [KY038](https://github.com/fizban99/microbit_ky038) ⭐ 1 | 🐛 1 | 🌐 Python | 📅 2021-07-24 - Library to calibrate and use a sound sensor KY038, including clap counter functionality.
* [Bosch BME280](https://github.com/jemerlia/microbit-BoschBME280-P-T-and-H-Sensor) ⭐ 1 | 🐛 2 | 🌐 C | 📅 2017-06-16 - Module for Bosch BME280 Pressure, Temperature and Humidity Sensor via I2C.
* [MY9221](https://github.com/mcauser/microbit-my9221) ⭐ 1 | 🐛 1 | 🌐 Python | 📅 2018-08-07 - Library for 10 segment LED bar graph modules using the MY9221 LED driver.
* [MCP3008](https://github.com/ti-nspire/microbit_MicroPython_MCP3008) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2018-07-02 - Library to interface with a MCP3008 10-bit Analog-to-Digital Converter (ADC).
* [MPR121](https://github.com/rhubarbdog/microbit-mpr121-keypad) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2018-12-16 - Library for the MPR121 Capacitive Touch Sensor over I2C.
* [24LCxxx EEPROM](https://github.com/matneee/microbit-I2C-EEPROM-24LCxxx-Read-Write) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2025-03-20 - Example micro:bit functions to read and write to a Microchip I2C EEPROM.
* [AM2320](https://github.com/mcauser/microbit-am2320) ⭐ 0 | 🐛 2 | 🌐 Python | 📅 2018-08-07 - Library for interfacing with an Aosong AM2320 temperature and humidity sensor over I2C.
* [HTU21D](https://github.com/ti-nspire/microbit-in-micropython-library-for-HTU21D-sensor) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2018-06-16 - Library to interface with a HTU21D digital humidity and temperature sensor.
...
* [Bluetooth Keyboard](https://github.com/kshoji/pxt-bluetooth-keyboard) ⭐ 53 | 🐛 3 | 🌐 C++ | 📅 2017-09-29 - MakeCode extension for BLE HID Keyboard module for micro:bit V1.
...
* [DSTemp](https://github.com/bsiever/microbit-dstemp) ⭐ 5 | 🐛 4 | 🌐 C++ | 📅 2026-06-27 - Read the temperature from one or multiple DS18B20 sensors.
* [VL53L0X](https://github.com/Tinkertanker/pxt-range-vl53l0x) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2022-02-11 - Package to calculate distances using a VL53L0X Time-of-Flight ranging sensor.
* [MLX90614](https://github.com/DoraLC/pxt-MLX90614) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2019-05-20 - I2C driver for Infra Red Thermometer MLX90614.
* [MCP23017](https://github.com/CaptainCredible/pxt-MCP23017) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2021-07-17 - MakeCode driver for the MCP23017 16-Bit I2C I/O Expander.
* [ubirch NB-IoT](https://github.com/ubirch/pxt-ubirch) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2018-04-18 - Package for sending signed data messages to the ubirch backend.
* [LumexOLED](https://github.com/lioujj/pxt-oled) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2019-02-08 - Package designed for Lumex OLED display.
* [TCS3200](https://github.com/DoraLC/pxt-tcs3200-color-sensor) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2019-01-28 - Control a TCS3200 colour sensor.
* [Invent robot](https://github.com/techcampuk/pxt-invent) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2019-03-28 - This library provides a Microsoft PXT package for Invent robot.
* [DS1307](https://github.com/Tinkertanker/pxt-realtimeclock-ds1307) ⭐ 1 | 🐛 1 | 🌐 TypeScript | 📅 2020-03-28 - Tinkercademy MakeCode package for using the DS1307 RTC (Real-Time Clock).
* [HT16K33](https://github.com/Tinkertanker/pxt-alphanumeric-ht16k33) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2022-02-16 - Tinkercademy MakeCode Package for the HT16K33 I2C Alphanumeric Display (beta).
* [SHT2X](https://github.com/Tinkertanker/microDriver_SHT2x) ⭐ 1 | 🐛 1 | 🌐 C++ | 📅 2022-02-28 - Driver for SHT20, SHT21, SHT25 digital sensor, to measure temperature and relative humidity.
* [PCA9685](https://github.com/Tinkertanker/uDriver_PCA9585) ⭐ 1 | 🐛 2 | 🌐 C++ | 📅 2018-02-12 - Package to control the PCA9685, a 16-channel PWM controller, with included servo support.
* [dstemp2wire](https://github.com/bsiever/microbit-dstemp-2wire) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2026-06-27 - This extension allows the micro:bit to use the Dallas Semiconductor DS18B20 temperature sensor with just two wires (parasitic power mode).
* [HoneyBit](https://github.com/HoneycombKits/pxt-HoneyBit) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2017-11-25 - A Honeycomb kits package for micro:bit MakeCode.
* [BMP085](https://github.com/sabas1080/uBit_BMP085) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2018-11-12 - Package to control the BMP085 or BMP180 pressure and altitude sensors.
* [KeiganMotor](https://github.com/keigan-motor/pxt-KeiganMotor) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2019-07-12 - Controller for KeiganMotor KM-1, an all-in-one brushless gearless electric motor module.
* [Adafruit Motor Driver Board](https://github.com/vijairaj/pxt-adafruit-motor-driver) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2019-06-09 - Driver to control the DC motors on the Adafruit Motor Shield v1.
* [ESP-01](https://github.com/51bit/esp01) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2019-09-05 - Control an ESP8266 module via serial AT commands.
* [DS3231](https://github.com/gbraad/pxt-rtc-ds3231) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2020-03-18 - RTC (Real Time Clock) MakeCode extension for the micro:bit.
* [MAX31855](https://github.com/bremoran/microDriver_max31855) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2020-06-28 - Driver for the MAX31855 Thermocouple Amplifier.
...
* [node-bbc-microbit](https://github.com/sandeepmistry/node-bbc-microbit) ⭐ 86 | 🐛 5 | 🌐 JavaScript | 📅 2018-08-05 - Control a micro:bit from Node.js using BLE.
* [microbit-web-bluetooth](https://github.com/thegecko/microbit-web-bluetooth) ⭐ 57 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-16 - Web Bluetooth library implementing the micro:bit Bluetooth Profile.
...
* [microbitFs](https://github.com/microbit-foundation/microbit-fs) ⭐ 15 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-14 - TypeScript library to manipulate files inside a micro:bit MicroPython hex file.
* [microbitUh](https://github.com/microbit-foundation/microbit-universal-hex/) ⭐ 13 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-14 - TypeScript/JavaScript library to combine micro:bit Hex files into a Universal Hex that works in all versions of the micro:bit.
...
* [Arduino nRF5](https://github.com/sandeepmistry/arduino-nRF5/) ⭐ 953 | 🐛 130 | 🌐 C | 📅 2024-05-22 - Arduino Core for Nordic Semiconductor nRF5 based boards, including the micro:bit.
* [MbedOS micro:bit V2 Starter](https://github.com/microbit-foundation/mbedos-microbit-v2-starter) ⭐ 7 | 🐛 3 | 🌐 C | 📅 2022-04-21 - MbedOS template project that adds support for the micro:bit V2.
...
* [blehid](https://github.com/bsiever/microbit-pxt-blehid) ⭐ 50 | 🐛 2 | 🌐 C++ | 📅 2024-04-21 - Set up the micro:bit V2 as a Bluetooth HID device, like a keyboard, mouse, or gamepad.
* [nRF51 Radio](https://github.com/tipih/NRF51_Radio_library) ⭐ 8 | 🐛 2 | 🌐 C++ | 📅 2022-12-17 - Arduino library based on the micro:bit DAL radio implementation.
* [micro:bit Video](https://github.com/blogmywiki/microbit-video) ⭐ 8 | 🐛 0 | 🌐 C++ | 📅 2021-10-22 - C++ programs for generating NTSC video from a V1 micro:bit to connect to a TV.
* [micro:bit Screen](https://github.com/ht-deko/microbit_Screen) ⭐ 5 | 🐛 1 | 🌐 C++ | 📅 2017-11-30 - Arduino LED Screen library for micro:bit.
* [MicrobitV2-HHS Arduino Lib](https://github.com/Grrtzm/MicrobitV2-HHS) ⭐ 3 | 🐛 0 | 🌐 C++ | 📅 2023-03-30 - Arduino library for micro:bit V2 for radio and PWM (including Servo and Tone).
* [microbit-dal-ext-kit](https://github.com/softgraph/microbit-dal-ext-kit) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2024-12-28 - A set of components and utilities for C++ applications using micro:bit DAL (runtime).
* [Distintiva micro:bit library](https://github.com/distintiva/distintiva_microbit_lib) ⭐ 0 | 🐛 0 | 📅 2022-05-20 - Arduino library to code the micro:bit on-board features using the Arduino IDE.

### ©️ C/C++ Libraries - Hardware Drivers

* [Adafruit Arduino micro:bit library](https://github.com/adafruit/Adafruit_Microbit) ⭐ 35 | 🐛 5 | 🌐 C++ | 📅 2023-11-15 - Wrapper code and examples for using micro:bit with Arduino IDE.
* [micro:Maqueen Arduino Lib](https://github.com/kd8bxp/micro-Maqueen-Arduino-Library) ⚠️ Archived - Arduino library for the DF Robot micro:bit Maqueen robot and controller.
* [OneWire](https://github.com/adamboardman/microbit-onewire) ⭐ 3 | 🐛 0 | 🌐 C++ | 📅 2017-01-19 - BBC micro:bit OneWire Library, based upon Erik Olieman's Mbed DS1820 lib.
* [VL53L0X](https://github.com/Tinkertanker/pxt-range-vl53l0x) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2022-02-11 - Driver for the VL53L0X Time-of-Flight ranging sensor.
* [KY-040](https://github.com/Tinkertanker/pxt-rotary-encoder-ky040) ⭐ 3 | 🐛 1 | 🌐 TypeScript | 📅 2022-02-28 - Library for using the KY-040 rotary encoder.
* [MMA8653](https://github.com/lfhohmann/MMA8653) ⭐ 3 | 🐛 0 | 🌐 C++ | 📅 2021-05-03 - This Arduino library brings support for the NXP MMA8653 I2C accelerometer.
* [neopixel](https://github.com/elmorg/uBit_neopixel) ⭐ 2 | 🐛 2 | 🌐 C | 📅 2016-08-18 - Library for using NeoPixels with the BBC micro:bit.
...
* [Mynewt](https://github.com/apache/mynewt-core) ⭐ 890 | 🐛 101 | 🌐 C | 📅 2026-08-11 - Open-source operating system for tiny embedded devices. Its goal is to make it easy to develop applications for microcontroller environments where power and cost are driving factors.
...
* [Bare metal examples](https://github.com/dwelch67/microbit) ⭐ 26 | 🐛 1 | 🌐 C | 📅 2021-12-31 - C bare metal examples for the BBC micro:bit.
* [Zephyr BBC micro:bit V2](https://github.com/fduignan/zephyr_bbc_microbit_v2) ⭐ 19 | 🐛 0 | 🌐 C | 📅 2024-09-23 - Various examples for Zephyr RTOS running on the BBC micro:bit V2.
* [nu-microbit-base](https://github.com/nu-ce346/nu-microbit-base) ⭐ 5 | 🐛 0 | 🌐 C | 📅 2026-05-08 - C bare metal environment using the Nordic SDK with example applications.
...
* [The Discovery book](https://github.com/rust-embedded/discovery/) ⭐ 1,601 | 🐛 108 | 🌐 Rust | 📅 2026-03-21 - This book is an introductory course on microcontroller-based embedded systems, using micro:bit, that uses Rust as the teaching language rather than the usual C/C++.
* [Running Rust code on a BBC micro:bit](https://github.com/SimonSapin/rust-on-bbc-microbit) ⭐ 195 | 🐛 3 | 📅 2025-09-02 - Article describing the experience and steps of compiling Rust code for the micro:bit with and without interaction with the runtime DAL.
...
* [micro:bit Rust Demos](https://github.com/dtcristo/microbit-demos) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2022-09-08 - Multiple Rust language demos running on the BBC micro:bit.
* [RGB LED Matrix](https://github.com/vhiribarren/nrf52833-rgb-led-matrix-lib-rust) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2026-01-03 - Rust project for the BBC micro:bit controlling a 64x32 matrix panel with some level shifters.
...
* [Tock](https://github.com/tock/tock/blob/master/boards/microbit_v2/README.md) ⭐ 6,410 | 🐛 209 | 🌐 Rust | 📅 2026-08-14 - An embedded operating system designed for running multiple concurrent, mutually distrustful applications on low-memory and low-power microcontrollers, with support for the BBC micro:bit.
...
* [Ada Drivers](https://github.com/AdaCore/Ada_Drivers_Library/tree/master/examples/MicroBit) ⭐ 283 | 🐛 24 | 🌐 Ada | 📅 2026-07-08 - Drivers for the micro:bit on-board components and instruction on how to setup the Ada development environment.
* [Ada micro:bit Examples](https://github.com/Fabien-Chouteau/microbit_examples) ⭐ 0 | 🐛 0 | 🌐 Ada | 📅 2020-10-02 - Examples and tutorials for Ada on the BBC micro:bit.
...
* [C# / F#](https://github.com/kekyo/IL2C) ⭐ 449 | 🐛 43 | 🌐 C# | 📅 2022-06-19 - IL2C is a translator implementation of .NET intermediate language to C language, with C# and F# examples for the micro:bit.
* [Zig](https://github.com/markfirmware/zig-bare-metal-microbit) ⭐ 38 | 🐛 4 | 🌐 Zig | 📅 2021-10-24 - A BBC micro:bit bare metal example in the Zig language.
* [TinyGo](https://tinygo.org/docs/reference/microcontrollers/boards/microbit/) - Go Language for microcontrollers and small systems, with out-of-box support for the BBC micro:bit ([examples](https://github.com/tinygo-org/tinygo-zoo) ⭐ 26 | 🐛 5 | 🌐 Go | 📅 2022-10-31).
* [MicroJIT](https://github.com/thomasdenney/microjit) ⭐ 12 | 🐛 0 | 🌐 C++ | 📅 2018-04-29 - A Just-In-Time compiler for [Alex Roger's Stack Virtual Machine](http://www.cs.ox.ac.uk/people/alex.rogers/stack/) on the BBC micro:bit.
* [Tiny BASIC](https://github.com/Tamakichi/ttbasic_microbit) ⭐ 8 | 🐛 0 | 🌐 C++ | 📅 2020-11-19 - Port for the micro:bit, including commands to use the on-board features, based on the Arduino port of the Tiny BASIC dialect.
...
* [CBMicroBit](https://github.com/Louismac/CBMicroBit) ⭐ 16 | 🐛 3 | 🌐 C++ | 📅 2019-03-11 - CoreBluetooth wrapper in C++ that connects a micro:bit to a computer running macOS using BLE and outputs over OSC (can be used standalone, or as a C++ or Objective C library).
* [Swift](https://github.com/phwallen/microbit-swift) ⭐ 15 | 🐛 1 | 🌐 Swift | 📅 2018-01-01 - An application programming interface written in Swift for use with the micro:bit. It allows programs written for Apple devices to communicate with the micro:bit using BLE.
* [Haxe node BBC micro:bit](https://github.com/MatthijsKamstra/hx-node-bbc-microbit) ⭐ 5 | 🐛 0 | 🌐 Haxe | 📅 2017-04-04 - Control a BBC micro:bit from Node.js using BLE and the Haxe programming language.
* [micro:bit for Dyalog APL on the Pi](https://github.com/APLPi/microbit) ⭐ 1 | 🐛 0 | 🌐 APL | 📅 2025-04-29 - Tools for using the micro:bit (via MicroPython serial connection) with the Dyalog APL programming language on the Raspberry Pi.
* [Node-RED](https://github.com/seanmtracey/node-red-contrib-bitio-wrapper) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2018-06-10 - A node-red (flow-based visual programming) module that wraps some of the functionality of the Python/MicroPython Bitio Library.
...
* [Vibrational Anomaly Detection](https://github.com/Technica-Corporation/microbit-ml) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2018-08-03 - This project introduces a statistics-based, time-series Vibrational Anomaly Detection using Tri-Axial accelerometer data on a micro:bit.
* [AlpacaML](https://github.com/LaboratoryForPlayfulComputation/AlpacaML) ⚠️ Archived - Automated Learning and Prototyping for Athletics and Creative Activity with Machine Learning. A wearable micro:bit connected to an app that can graph the data and learn to classify actions based off of the users criteria.
...
* [Vagrant Development Environment for C/C++, MicroPython and Makecode](https://github.com/carlosperate/microbit-dev-env) ⭐ 26 | 🐛 0 | 🌐 Shell | 📅 2022-03-28 - Creates a virtual machine with the toolchain required to create C/C++ programs, develop/compile MicroPython, and create packages for MakeCode.
* [Docker micro:bit Toolchain](https://github.com/carlosperate/docker-microbit-toolchain) ⭐ 17 | 🐛 3 | 🌐 Shell | 📅 2022-06-08 - Docker image with the micro:bit toolchain, useful to easily compile C/C++ programmes like DAL & CODAL (the micro:bit runtime), MicroPython, DAPLink, etc.
* [micro:bit PXT code extractor](https://github.com/maehw/microbit-pxt-code-extractor) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-02-21 - Tool to extract the embedded source code from Universal Hex files generated by the MakeCode editor.
...
* [micro:bit USB Grapher](https://github.com/bsiever/microbit-usb-grapher) ⭐ 10 | 🐛 33 | 🌐 JavaScript | 📅 2023-01-05 - A web page using WebUSB to graph, manipulate, and save data collected on the micro:bit.
* [HOVER:BIT Bluetooth Controller](https://github.com/JakobST1n/microbit-gamepad) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2023-02-06 - A web app for sending DPAD events to micro:bit devices over Bluetooth.
* [midi2ubit](https://github.com/63rabbits/midi2ubit) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2023-04-12 - Convert MIDI notes to notes-string for micro:bit. The notes-string can then be played using a MakeCode extention.
...
* [micro:bit Blue](https://github.com/microbit-foundation/microbit-blue) ⭐ 67 | 🐛 1 | 🌐 Java | 📅 2017-03-26 - Android app that contains a series of demos for interacting with the micro:bit using Bluetooth.
* [Official Swift Playgrounds](https://microbit.org/get-started/user-guide/mobile/) - ([Source Code](https://github.com/microbit-foundation/microbit-swift-playgrounds) ⚠️ Archived) Swift Playgrounds is an app for the iPad that helps teach people to code in the Swift language using interactive 'books'.
* [Official Android App](https://play.google.com/store/apps/details?id=com.samsung.microbit) - ([Source Code](https://github.com/microbit-foundation/microbit-android) ⭐ 21 | 🐛 34 | 🌐 Java | 📅 2026-07-22) Pair, program and flash programs to the micro:bit via Bluetooth.
* [micro:bit Slither](https://github.com/novucs/microbit-slither) ⭐ 5 | 🐛 0 | 🌐 Kotlin | 📅 2019-01-27 - Multiplayer snake game on Android, controlled with micro:bits via Bluetooth.
...
* [HandShake](https://github.com/mattoppenheim/microbit_hand_shake) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2023-08-06 - Project designed to enable unique gesture recognition for people with limited control of their motion.
...
* [OpenHaystack](https://github.com/seemoo-lab/openhaystack) ⭐ 13,249 | 🐛 146 | 🌐 Swift | 📅 2024-07-09 - Framework for tracking personal Bluetooth devices via Apple's massive Find My network. Build your own 'AirTags' with a micro:bit.
...
* [DAPLink source code](https://github.com/ARMmbed/DAPLink) ⭐ 2,784 | 🐛 140 | 🌐 C | 📅 2026-07-13 - Source code for DAPLink, the firmware running on the Interface Chip.
...
* [micro:bit V1 Reference Design](https://github.com/microbit-foundation/microbit-reference-design) ⭐ 245 | 🐛 10 | 🌐 Scheme | 📅 2021-03-29 - Hardware design files for a board 100% binary compatible with the micro:bit. Created to help make your own micro:bit derived designs.
* [micro:bit V1 Hardware Design](https://github.com/bbcmicrobit/hardware) ⭐ 157 | 🐛 1 | 📅 2021-03-19 - Schematics and bill of materials for the BBC micro:bit.
* [micro:bit V2 Hardware Design](https://github.com/microbit-foundation/microbit-v2-hardware) ⭐ 96 | 🐛 2 | 📅 2022-08-18 - Schematics and bill of materials for the BBC micro:bit V2.
...
* [Sumo Robot](https://github.com/hansj66/micro-bot) ⭐ 13 | 🐛 3 | 🌐 C | 📅 2022-09-27 - Firmware and hardware design files for the TimeExpander.com micro:bit robot with 2 motor bridges, 3 time of flight sensors, 4 reflective object sensors, and a GPIO expander.
* [micro:bit Kicad Edge Connector Socket](https://github.com/JordanElectronics/kicad-microbit-edge-connector) ⭐ 10 | 🐛 1 | 📅 2018-05-28 - BBC micro:bit Edge Connector component library and PCB footprint for Kicad.
* [SparkFun moto:bit](https://github.com/sparkfun/Micro_Bit_Moto_Bit) ⭐ 9 | 🐛 1 | 📅 2020-01-22 - Open source files for the SparkFun moto:bit, a board to provide a robotics platform.
* [micro:bit Badge](https://github.com/makezurich/micro-bit-badge) ⚠️ Archived - Open Source PCB for the micro:bit with a battery holder, buzzer, extension edge connector and pins breaks out.
* [SparkFun weather:bit](https://github.com/sparkfun/Micro_Bit_Weather_Bit) ⭐ 7 | 🐛 4 | 📅 2020-05-11 - Open source files for the SparkFun weather:bit, a board to provide a weather station.
* [SparkFun gamer:bit](https://github.com/sparkfun/Micro_Bit_Controller_Bit) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2020-07-14 - Open source files for the SparkFun gamer:bit, a board to provide a game system.
* [NeoBit](https://github.com/mignon-p/NeoBit) ⭐ 6 | 🐛 0 | 📅 2021-10-22 - Open source board that lets you hook up NeoPixel and DotStar LEDs to a BBC micro:bit, also contains a headphone jack and a couple of slide potentiometers for input.
* [LoRaWAN micro:bit](https://github.com/ribbotson/LoRaWAN_MicroBit) ⭐ 5 | 🐛 0 | 🌐 Eagle | 📅 2017-09-10 - This is a free open source LoRaWAN interface for BBC micro:bit including power control timer.
* [Eagle micro:bit Edge Connector Socket](https://github.com/proto-pic/micro-bit-eagle-libraries) ⭐ 4 | 🐛 0 | 📅 2017-04-12 - Eagle library from Proto-Pic for the micro:bit edge connectors.
* [solder:bit Gamepad](https://github.com/devices-lab/solderbit-gamepad/) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-07-16 - Open source micro:bit gamepad with RGB LEDs, designed as a kit to learn how to solder with surface-mount components.
* [micro:bit PCB Edge Connector](https://github.com/JohnVidler/kicad-microbit-v2-edge-connector) ⭐ 2 | 🐛 1 | 📅 2024-06-26 - A reproduction of the micro:bit V2 PCB edge connector for KiCAD.
* [SparkFun Breakout Board](https://github.com/sparkfun/Micro_Bit_Breakout) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2021-06-18 - Open source files for the SparkFun micro:bit Breakout Board.
* [PiicoDev Adapter](https://github.com/CoreElectronics/CE-PiicoDev-Adapter-for-Microbit) ⭐ 0 | 🐛 0 | 📅 2021-11-01 - Kicad files for an adapter to experiment with sensors from the PiicoDev range.
...
* [miniPOW](https://github.com/GeorgeChiou/miniPOW) ⭐ 14 | 🐛 2 | 📅 2019-10-09 \[[Bulldozer](https://www.thingiverse.com/thing:3330288)], \[[Tank Base](https://www.thingiverse.com/thing:3341546)], \[[WALL-E](https://www.thingiverse.com/thing:3456871)] - Models using a Power Board for the BBC micro:bit.
...
* [micro:bit SVG](https://github.com/microbit-foundation/microbit-svg) ⭐ 25 | 🐛 0 | 📅 2021-03-30 - A detailed SVG (Scalable Vector Graphics) drawing of the BBC micro:bit.
* [micro:bit Fritzing Part](https://github.com/topshed/FritzingParts) ⭐ 12 | 🐛 0 | 📅 2017-06-26 - Richard Hayler collection of Fritzing parts contains a model for the micro:bit.
* [MonkMakes micro:bit Diagramming Kit](https://github.com/simonmonk/mm_mb_diagramming_kit) ⭐ 6 | 🐛 0 | 📅 2021-11-15 - An SVG file template for drawing BBC micro:bit wiring diagrams using alligator clips.
...
* [MicroBike](https://github.com/musabkilic/MicroBike) ⭐ 33 | 🐛 0 | 🌐 Python | 📅 2021-03-02 - Turn your micro:bit into a game controller.
* [Smart Garden Ornaments](https://github.com/jimbobbennett/smart-garden-ornaments) ⭐ 29 | 🐛 3 | 🌐 Python | 📅 2021-04-30 - Track things happening in your garden, neighbourhood, or school using smart ornaments with the BBC micro:bit, Raspberry Pi, and a cloud-based IoT service.
* [micro:bit Corona Scanner](https://github.com/znuh/microbit-corona-scanner) ⭐ 17 | 🐛 0 | 🌐 JavaScript | 📅 2020-07-28 - Using a micro:bit to listen to Bluetooth COVID-19 Exposure Notifications from COVID mobile apps.
* [microbit-beacon-finder](https://github.com/kshoji/microbit-beacon-finder) ⭐ 11 | 🐛 2 | 🌐 C++ | 📅 2020-02-12 - The micro:bit finds various types of BLE Beacons, and displays their ID to the LEDs.
...
* [Python For Kids](https://github.com/mytechnotalent/Python-For-Kids) ⭐ 795 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - A comprehensive online Python development course for kids utilizing a BBC micro:bit going step-by-step into the world of Python for microcontrollers.
