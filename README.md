...
Inspired by the [Awesome lists](https://github.com/sindresorhus/awesome) ⭐ 508,214 | 🐛 106 | 📅 2026-09-02.
...
* [Arduino nRF5](https://github.com/sandeepmistry/arduino-nRF5/) ⭐ 955 | 🐛 130 | 🌐 C | 📅 2024-05-22 - Arduino Core for Nordic Semiconductor nRF5 based boards, including the micro:bit.
...
* [Tock](https://github.com/tock/tock/blob/master/boards/microbit_v2/README.md) ⭐ 6,444 | 🐛 215 | 🌐 Rust | 📅 2026-09-19 - An embedded operating system designed for running multiple concurrent, mutually distrustful applications on low-memory and low-power microcontrollers, with support for the BBC micro:bit.
...
* [OpenHaystack](https://github.com/seemoo-lab/openhaystack) ⭐ 13,566 | 🐛 145 | 🌐 Swift | 📅 2026-08-17 - Framework for tracking personal Bluetooth devices via Apple's massive Find My network. Build your own 'AirTags' with a micro:bit.
...
* [DAPLink source code](https://github.com/ARMmbed/DAPLink) ⭐ 2,808 | 🐛 140 | 🌐 C | 📅 2026-08-20 - Source code for DAPLink, the firmware running on the Interface Chip.
...
* [Python For Kids](https://github.com/mytechnotalent/Python-For-Kids) ⭐ 799 | 🐛 0 | 🌐 Python | 📅 2026-09-20 - A comprehensive online Python development course for kids utilizing a BBC micro:bit going step-by-step into the world of Python for microcontrollers.
