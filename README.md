...
* [Mynewt](https://github.com/apache/mynewt-core) ⭐ 891 | 🐛 99 | 🌐 C | 📅 2026-09-12 - Open-source operating system for tiny embedded devices. Its goal is to make it easy to develop applications for microcontroller environments where power and cost are driving factors.
...
* [DAPLink source code](https://github.com/ARMmbed/DAPLink) ⭐ 2,804 | 🐛 140 | 🌐 C | 📅 2026-08-20 - Source code for DAPLink, the firmware running on the Interface Chip.
